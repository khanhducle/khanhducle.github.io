...
- In the offline stage, each image in the database is represented by some feature vectors (Feature Extraction0 and then indexed in the database using some data structure (Database Indexing).
